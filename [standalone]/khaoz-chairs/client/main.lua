...
-- RegisterCommand("spawnchair1", function()
-- 	greenchair()
-- end)
...
-- 	RegisterCommand("spawnchair1", function(source)
-- 	--RegisterCommand(Config["Chair1Command"], function(source)
-- 		greenchair()
-- 	end)
	
-- 	RegisterCommand("spawnchair2", function(source)
...
RegisterCommand("spawnchair2", function()
--RegisterCommand(Config["Chair2Command"], function(source)
	pladchair()
end)


RegisterNetEvent("lawnchairs:client:chair1")
AddEventHandler("lawnchairs:client:chair1", function(source)
	greenchair()
end)
RegisterNetEvent("khaoz-chairs:Chair2")
AddEventHandler("khaoz-chairs:Chair2", function(source)
	pladchair()
end)
